...
public class StatsRecord extends Thread {
    ...
    public void gather() {
        ...
        String mcVersion = ServerLifecycleHooks.getCurrentServer().getServerVersion();
        ...
        content = "postid=pluginstats&plugin=Denizen"
                ...
                + "&pl_player_count=" + ServerLifecycleHooks.getCurrentServer().getPlayerList().getPlayers().size()
