    ...
    public static boolean isRecipeOfType(Recipe recipe, String type) {
        return type == null || (
                (type.equals("crafting") && (recipe instanceof ShapedRecipe || recipe instanceof ShapelessRecipe)) ||
                        (type.equals("furnace") && recipe instanceof SmeltingRecipe) ||
                        (type.equals("blasting") && recipe instanceof BlastingRecipe) ||
                        (type.equals("campfire") && recipe instanceof CampfireCookingRecipe) ||
                        ...
                        (type.equals("stonecutting") && recipe instanceof StonecutterRecipe) ||
                        (type.equals("smithing") && recipe instanceof UpgradeRecipe));
    }
...
//        location.ConvertToIntegerLocation();
//
