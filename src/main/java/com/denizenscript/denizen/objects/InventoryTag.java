...
public class InventoryTag implements ObjectTag, Notable, Adjustable, FlaggableObject {
    ...
    public static InventoryTag mirrorBukkitInventory(AbstractContainerMenu inventory) {
        if (inventory == null) {
            return null;
        }
...
//                            }
//                            pl.inventoryMenu
//                            Container opened = InventoryViewUtil.getTopInventory(player.getPlayerEntity().getOpenInventory());
